...
- **[`RTLWrapper` (TOML-based wrapping)](rtl-wrapper.md)** — higher-level wrapper with auto-mapping, sv2v preprocessing, and a worked CV32E40P example
...
├── rtl-wrapper.md              # TOML-based RTLWrapper (with CV32E40P example)
